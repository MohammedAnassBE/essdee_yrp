...
from essdee_yrp.cutting.lay_optimizer.common import validate_inputs, validate_plan
from essdee_yrp.cutting.lay_optimizer.core import optimize_lay_plan
from essdee_yrp.cutting.lay_optimizer.strategy_cp_sat import solve as solve_cp_sat
...
class ProcessIsolationTests(unittest.TestCase):
    def test_cli_process_returns_structured_result(self):
        completed = subprocess.run(
            [
                sys.executable, "-m", "essdee_yrp.cutting.lay_optimizer",
                "--order", "S:25,M:150,L:200,XL:100,2XL:25",
