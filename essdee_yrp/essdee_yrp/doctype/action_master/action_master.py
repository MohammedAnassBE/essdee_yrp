...
class ActionMaster(Document):
	...
	def before_save(self):
		from essdee_yrp.essdee_yrp.doctype.time_and_action.time_and_action import get_t_and_a_preview_data
...
def create_master_template(doc_name):
	...
	master_doc.check_permission("read")
	frappe.has_permission("Action Master Template", "create", throw=True)
