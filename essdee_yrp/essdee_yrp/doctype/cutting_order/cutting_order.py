...
def calculate_laysheets(cutting_order):
	frappe.get_doc("Cutting Order", cutting_order).check_permission("write")
...
def calc_laysheets(cutting_order):
	...
	from essdee_yrp.essdee_yrp.doctype.cutting_laysheet.cutting_laysheet import update_cutting_plan
