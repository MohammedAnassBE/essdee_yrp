...
frappe.ui.form.on("Cutting Order Detail", {
			...
			frm.add_custom_button("Duplicate COD", () => {
				let d = new frappe.ui.Dialog({
					...
					primary_action(values) {
						frappe.call({
							method: "essdee_yrp.essdee_yrp.doctype.cutting_order_detail.cutting_order_detail.duplicate_cod",
							args: {
								cod: frm.doc.name,
								item: values.item,
							},
	...
	get_panel_combination(frm) {
		...
		frappe.call({
			method: 'essdee_yrp.essdee_yrp.doctype.cutting_order_detail.cutting_order_detail.get_co_new_combination',
			args: {
				attribute_mapping_value: frm.stiching_attribute_mapping,
				packing_attribute_details: frm.doc.attribute_values,
