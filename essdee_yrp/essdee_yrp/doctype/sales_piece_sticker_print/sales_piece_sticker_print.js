            ...
            frm.add_custom_button("Print", ()=> {
                frappe.ui.form.qz_connect()
                    ...
                    .then(function (printers) {
                        frappe.call({
                            method:'essdee_yrp.essdee_yrp.doctype.box_sticker_print.box_sticker_print.get_printer',
                            args: {
                                printers: printers,
                            },
                            callback: function(r){
...
function print_labels(frm, printer){
    frappe.call({
        method:'essdee_yrp.essdee_yrp.doctype.sales_piece_sticker_print.sales_piece_sticker_print.get_print_format',
        args: {
