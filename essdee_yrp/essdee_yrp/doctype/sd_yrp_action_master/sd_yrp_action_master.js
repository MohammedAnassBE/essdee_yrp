...
frappe.ui.form.on("SD YRP Action Master", {
    refresh(frm){
            ...
            frm.add_custom_button("Create Template", ()=> {
                let d = new frappe.ui.Dialog({
                    ...
                    primary_action(){
                        d.hide()
                        frappe.call({
                            method: "essdee_yrp.essdee_yrp.doctype.sd_yrp_action_master.sd_yrp_action_master.create_master_template",
                            args: {
    ...
    action_master_template(frm){
        if(frm.doc.action_master_template){
            frappe.call({
                method: "essdee_yrp.essdee_yrp.doctype.sd_yrp_action_master.sd_yrp_action_master.get_template_details",
                args: {
