...
class SDYRPEssdeeSidebarSetting(Document):
	...
	browsers/devices (mirrors the per-user "SD YRP Essdee Child Table View Setting"
	pattern).
	"""
...
EssdeeSidebarSetting = SDYRPEssdeeSidebarSetting
