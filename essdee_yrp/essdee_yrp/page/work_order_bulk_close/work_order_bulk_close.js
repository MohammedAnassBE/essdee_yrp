...
class WorkOrderBulkClose {
  ...
  async load_work_orders() {
    ...
    try {
      const work_orders = await frappe.xcall(
        "essdee_yrp.essdee_yrp.page.work_order_bulk_close.work_order_bulk_close.get_open_work_orders",
        filters
      );
  ...
  async show_work_order_details(work_order) {
    ...
    try {
      const details = await frappe.xcall(
        "essdee_yrp.essdee_yrp.page.work_order_bulk_close.work_order_bulk_close.get_work_order_close_details",
  ...
  close_work_orders(work_orders, values, dialog) {
    ...
    frappe.call({
      method:
        "essdee_yrp.essdee_yrp.page.work_order_bulk_close.work_order_bulk_close.close_work_orders",
      args: {
