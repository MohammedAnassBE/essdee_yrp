		...
		"filters": [
			[
				...
				[
					...
					"YRP Delivery Challan-total_delivered_qty-precision",
					"YRP Delivery Challan Item-secondary_qty-precision",
					"YRP Delivery Challan Item-delivered_quantity-precision",
					"YRP Delivery Challan Item-pending_quantity-precision",
					"YRP Delivery Challan Item-ste_delivered_quantity-precision",
					"YRP Goods Received Note-naming_series-options",
					"YRP Goods Received Note-naming_series-default",
					"YRP Goods Received Note Item-quantity-precision",
					"YRP Goods Received Note Item-stock_qty-precision",
