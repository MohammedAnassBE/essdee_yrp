...
IPD_CUSTOM_FIELDS = [
	...
	_field(
		...
		options='SD YRP Item Production Detail Packing Attribute Detail',
	),
	_field(
	...
	_field(
		...
		options='SD YRP Item Production Detail Packing Size Detail',
	...
	_field(
		...
		options='SD YRP Item Production Detail Packing Assortment Attribute',
		hidden=1,
	...
	_field(
		...
		options='SD YRP Item Production Detail Set Item Combination',
		hidden=1,
	),
	...
	_field("stiching_item_details", "Table", "Stiching Item Details", options='SD YRP Stiching Item Detail'),
	...
	_field("cutting_marker_groups", "Table", "Cutting Marker Groups", options='SD YRP Cutting Marker Group', hidden=1),
	...
	_field(
		...
		"Table MultiSelect",
		"Cloth Attributes",
		options='SD YRP Cutting Attribute Detail',
		hidden=1,
	),
	_field("cloth_detail", "Table", "Cloth Detail", options='SD YRP Item Production Detail Cloth Detail'),
	...
	_field("cutting_process", "Link", "Cutting Process", options='YRP Process'),
]
