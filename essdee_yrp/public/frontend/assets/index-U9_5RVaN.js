import{c as h,bo as p,b1 as l,ab as c,b9 as u,aS as s,bp as E,a7 as b,n as A,ak as x,o as $,s as R,bY as w,C as D,K as v,bN as W,V as S,bc as O,bU as y,a8 as m,bd as k,a9 as T,aN as I,a1 as _,Q as f,bT as N,aU as V,h as L,bQ as j}from"./essdee-DHD8MUE8.js";import{k as H}from"./useToast-hl9DtadI.js";import{d as U}from"./index-fE64aUiN.js";var M=`
    .p-tabs {
        display: flex;
...
`,Q={root:function(t){var a=t.props;return["p-tabs p-component",{"p-tabs-scrollable":a.scrollable}]}},Y=h.extend({name:"tabs",style:M,classes:Q}),Z={name:"BaseTabs",extends:p,props:{value:{type:[String,Number],default:void 0},lazy:{type:Boolean,default:!1},scrollable:{type:Boolean,default:!1},showNavigators:{type:Boolean,default:!0},tabindex:{type:Number,default:0},selectOnFocus:{type:Boolean,default:!1}},style:Y,provide:function(){return{$pcTabs:this,$parentInstance:this}}},q={name:"Tabs",extends:Z,inheritAttrs:!1,emits:["update:value"],data:function(){return{d_value:this.value}},watch:{value:function(t){this.d_value=t}},methods:{updateValue:function(t){this.d_value!==t&&(this.d_value=t,this.$emit("update:value",t))},isVertical:function(){return this.orientation==="vertical"}}};function G(e,t,a,i,r,n){return l(),c("div",s({class:e.cx("root")},e.ptmi("root")),[u(e.$slots,"default")],16)}q.render=G;var z={name:"ChevronLeftIcon",extends:E};function J(e){return nt(e)||et(e)||tt(e)||X()}function X(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
