<template>
    <div ref='root'>
        ...
        <div style="margin-top:20px;">
			...
			<div class="row pt-3" v-if="!locked_status && show_button1 && docstatus != null">
            ...
            <div class="html-container col mt-1">
                ...
                <div class="row" v-if="!is_manual_entry">
					<div class="pl-4" v-if="!locked_status && show_button4">
                        <button class="btn btn-info pull-left" @click="add_entries()">Add Entries</button>
                    </div>
					<div class="pl-4"  v-if="!locked_status && show_button5">
			...
			<div class="row" style="padding-left: 35px;" v-if="!locked_status && show_button2">
			...
			<div class="row" style="padding-left: 35px;" v-if="!locked_status && show_button3">
...
const locked_status = computed(() =>
	["Approval Pending", "Label Printed", "Cancelled"].includes(status.value)
)
let set_parameters = []
let fieldnames = []
...
function set_status(new_status){
	...
	disabled.value = locked_status.value
}
