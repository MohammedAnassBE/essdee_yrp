<template>
    <div class="dpr-tab">
        ...
        <div v-else class="empty-state">
            <p>{{ selected_date ? 'No production data for the selected filters' : 'Select a Date to view the report' }}</p>
        </div>
    </div>
</template>
...
const hasReportData = computed(() => {
    return (headers.value || []).some((header) => Object.prototype.hasOwnProperty.call(data.value || {}, header))
})
