                ...
                <table class="report-table">
                    ...
                    <tbody>
                        <tr v-for="(row, idx) in displayData" :key="idx" class="data-row" :style="idx === 0 ? 'background: bisque' : ''">
                            <template v-if="idx == 0">
                                <td v-for="header in items['header1']" :key="header" class="data-cell"></td>
...
/* Sticky identity columns from the migrated status-summary contract. */
...
.report-table th:nth-child(3), .report-table td:nth-child(3) { left: 340px; min-width: 170px; }
.report-table th:nth-child(4), .report-table td:nth-child(4) { left: 510px; min-width: 110px; }
